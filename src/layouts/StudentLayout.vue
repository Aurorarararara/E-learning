  ...
  <el-container class="common-layout">
    <el-header class="common-header">
      <div class="header-content">
        <div class="logo-area">
          <span class="app-title">E-learning 平台 (学生端)</span>
        </div>
        <div class="user-actions">
          <el-dropdown @command="handleUserCommand">
            <span class="el-dropdown-link">
              欢迎您，王同学
              <el-avatar size="small" style="margin-left: 8px; vertical-align: middle;">王</el-avatar>
        ...
        <el-scrollbar>
          ...
          >
            ...
            <el-menu-item index="/student/assignments">
              ...
              <template #title><span>我的作业/测试</span></template>
            </el-menu-item>
            <el-menu-item index="/student/resources">
              <el-icon><IEpFolderOpened /></el-icon> <template #title><span>课程资源</span></template>
            </el-menu-item>
...
import {
  ...
  UserFilled as IEpUserFilled, // 虽然是学生端，但用户图标依然可用
  ...
  Expand as IEpExpand,
  Fold as IEpFold,
  // 新增图标，确保你安装了 @element-plus/icons-vue 并正确导入
  FolderOpened as IEpFolderOpened, // 用于课程资源
  List as IEpList, // 假设用于选课中心
...
const logout = () => {
  ElMessageBox.confirm('您确定要退出登录吗?', '提示', {
    ...
    localStorage.removeItem('userRole'); // 可能还需要清除角色信息
...
const handleUserCommand = (command) => {
  if (command === 'logout') {
    ...
    ElMessage.info('学生端系统设置功能待开发');
  }
};

// TODO: 在这里获取当前学生信息并显示在 header 中 (例如从 Pinia store 或 API)
// const userName = ref('王同学'); // 可以从 store 中获取学生姓名
// const userAvatarText = ref('王'); // 可以从学生姓名中提取第一个字

</script>

<style scoped>
/* 保持大部分样式与教师端一致，只调整少量可能不同的地方 */
